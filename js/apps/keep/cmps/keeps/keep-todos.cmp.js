                ...
                <ul class="todo-list">
                    <li v-for="(todo, idx) in keep.info.todos">
                        <div class="todo-content">
                            <pre class="todo-txt" contenteditable v-text="todo.txt" @blur="updateTodoTxt($event, idx)"/>  
                            <br>
                        </div>
                        <div class="todo-controls">
                            ...
                            <svg v-if="todo.doneAt"  @click="toggleDoneTodo(todo)" class="done" enable-background="new 0 0 1000 1000" viewBox="0 0 1000 1000" xmlns="http://www.w3.org/2000/svg"><path d="m351.6 352.2-101.3 108.6 255.5 239.5 484.2-498.3-88.5-81.3-397.7 385.7z"/><path d="m130.1 19.4c-66.4 0-120.1 53.7-120.1 120.2v720.9c0 66.5 53.7 120.1 120.1 120.1h720.9c66.5 0 120.1-53.7 120.1-120.1v-455.8l-120.1 116.5v299.2c0 22-18 40-40 40h-640.8c-22 0-40-18-40-40v-640.8c0-22 18-40 40-40h505.8l107.7-117.8z"/></svg>
                            ...
                            <span class="done-at" v-text="timeSince(todo.doneAt)" v-if="todo.doneAt"/>
                        </div>
                    </li>
                </ul>
