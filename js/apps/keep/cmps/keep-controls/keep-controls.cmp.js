...
export default {
    ...
    template: `
        <div class="keep-controls">
            ...
            <router-link class="mail-icon" :to="composeUrl">
            ...
            <svg @click="toggleArchived" enable-background="new 0 0 958 958" viewBox="0 0 958 958" xmlns="http://www.w3.org/2000/svg"><path d="m394 17.05v386.7h-144.4l229.4 327.2 229.399-327.2h-144.399v-386.7z"/><path d="m788 770.95h-618v-71h-170v241h958v-241h-170z"/></svg>
