...
export default {
    ...
    template: `
        <div class="keep-controls">
            ...
            <svg :class="{pinned: keep.isPinned}" @click="toggleArchived" enable-background="new 0 0 512 512" viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"><g fill="none" fill-rule="evenodd" transform="translate(-3 -3)"><path d="m0 0h24v24h-24z"/><path d="m19 3h-14.01c-1.11 0-1.99.9-1.99 2v14c0 1.1.88 2 1.99 2h14.01c1.1 0 2-.9 2-2v-14c0-1.1-.9-2-2-2zm0 12h-3.13c-.47 0-.85.34-.98.8-.35 1.27-1.52 2.2-2.89 2.2s-2.54-.93-2.89-2.2c-.13-.46-.51-.8-.98-.8h-3.14v-9c0-.55.45-1 1-1h12.01c.55 0 1 .45 1 1zm-3-5h-2v-3h-4v3h-2l3.65 3.65c.2.2.51.2.71 0z"/></g></svg>
        </div>
    `,
    components: {
        keepColor,
    ...
    methods: {
        ...
        toggleArchived() {
            this.keep.isArchived = !this.keep.isArchived
            this.updateKeep(this.keep);
        },
        sendAsMail() {
