...
var defaultInboxMails = [
    ...
    { to: 'Ori Shemla', copy: '', blindCopy:'', sender: 'Jimmy Page', subject: 'Check out our newest album', body: 'Our fresh new album is out and you get the opportunity to listen to it first!', isRead: true, sentAt: 1546733950594, id: 'A1033' },
    { to: 'Ori Shemla', copy: '', blindCopy:'', sender: 'Google', subject: 'Alert! Your account might have been hacked', body: 'If you have just logged in from China please ignore this message.', isRead: true, sentAt: 1541033950594, id: 'A1045' },
...
var defaultSentMails = [
    { to: 'Chiko Samuel', copy: '', blindCopy:'', sender: 'Ori Shemla', subject: 'Yo, wanna play?', body: 'Let\' catch up and play', isRead: true, sentAt: 1593033250594, id: 'B1030' },
    { to: 'King Shark', copy: '', blindCopy:'', sender: 'Ori Shemla', subject: 'I\'m hungry, do you want a burger?', body: 'I\'m going to eat the whole menu. I\'m not kidding just order every single thing for me.', isRead: true, sentAt: 1551033250594, id: 'B1040' },
    { to: 'Jimmy Page', copy: '', blindCopy:'', sender: 'Ori Shemla', subject: 'That is actually an awesome album!', body: 'I think your going to be really famous! Please don\'t forget me when you go on a world tour..', isRead: true, sentAt: 1541033250594, id: 'B1050' },
    { to: 'Eli Ohana', copy: '', blindCopy:'', sender: 'Ori Shemla', subject: 'You are the best in history!', body: 'I think you are the best player ever. Please don\'t ever leave...', isRead: true, sentAt: 1501033250594, id: 'B1060' },
    { to: 'Donald Trump', copy: '', blindCopy:'', sender: 'Ori Shemla', subject: 'Are you really going to lose?', body: 'I thought that you are so confident about Elections Day.', isRead: true, sentAt: 1501013250594, id: 'B1061' },
    { to: 'NoReply', copy: '', blindCopy:'', sender: 'Ori Shemla', subject: 'I will reply anyways.', body: 'Just don\'t tell me I cant reply to that address.', isRead: true, sentAt: 1500513250594, id: 'B1063' },
]
